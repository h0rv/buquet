...
```bash
# Choose exporter
export QO_METRICS_EXPORTER=prometheus  # or: statsd, datadog, opentelemetry, otlp

# Prometheus options
export QO_METRICS_PROMETHEUS_PORT=9000

# StatsD/Datadog options
export QO_METRICS_STATSD_HOST=127.0.0.1
export QO_METRICS_STATSD_PORT=8125

# OpenTelemetry options
export QO_METRICS_OTLP_ENDPOINT=http://localhost:4317
```
