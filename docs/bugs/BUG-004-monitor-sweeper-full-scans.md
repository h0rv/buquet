...
### Monitor Changes (`crates/oq/src/worker/monitor.rs`)
...
### Sweeper Changes (`crates/oq/src/worker/sweeper.rs`)
...
### Config Changes (`crates/oq/src/config.rs`)

Added new environment variables:
- `OQ_MONITOR_MAX_TASKS_PER_SCAN`: Limit tasks per monitor cycle
- `OQ_SWEEPER_MAX_OBJECTS_PER_SWEEP`: Limit objects per sweeper cycle
- `OQ_SWEEPER_MODE`: "continuous" or "on_demand"
