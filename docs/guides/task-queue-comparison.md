...
A comprehensive comparison of oq against other task queue and workflow orchestration systems.
...
|--------|------:|----------|---------|---------|:-------------:|------|
| [**oq**](https://github.com/anthropics/oq) | - | Rust | S3 only | MIT | No | Rust, Python |
...
|--------|:-------:|:--------:|:----------:|:----------:|:-------------:|:--------------:|:----------------:|
| **oq** | Yes | Yes | Yes | No | Yes (pattern) | Planned | Yes (dashboard) |
...
| Field | Value |
|-------|-------|
| **GitHub URL** | https://github.com/anthropics/oq |
...
- Workflows/DAGs: Planned (oq-workflows package)
- Observability/UI: Yes (web dashboard, `oq tail` live stream)
