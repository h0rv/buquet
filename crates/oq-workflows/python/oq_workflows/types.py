...
from oq_workflows._oq_workflows import StepState as RustStepState
from oq_workflows._oq_workflows import StepStatus as RustStepStatus
from oq_workflows._oq_workflows import WorkflowErrorInfo as RustError
from oq_workflows._oq_workflows import WorkflowState as RustWorkflowState
from oq_workflows._oq_workflows import WorkflowStatus as RustWorkflowStatus
...
class TaskContext(Protocol):
    """Protocol for task context from the oq native module."""
