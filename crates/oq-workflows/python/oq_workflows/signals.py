...
from oq_workflows._oq_workflows import parse_signal_key as _parse_signal_key

from ._rust import get_engine
from .state import update_workflow_state
from .types import Signal, SignalCursor, WorkflowState
...
async def send_signal(
    ...
    Args:
        queue: The oq queue (used for timestamp)
        wf_id: Workflow ID
