...
def register_workflow(
    ...
    """
    Register all workflow handlers with an qo worker.
    ...
    Args:
        worker: The qo worker
        workflow: The workflow definition
        queue: The qo queue

    Example:
        import qo
        from qow import Workflow, WorkflowClient, register_workflow
        ...
        worker = qo.Worker(queue, "worker-1", queue.all_shards())
...
def register_workflows(
    ...
    """
    Register multiple workflows with an qo worker.
