...
class TestNativeModuleTypes:
    ...
    def test_parse_signal_key_importable(self) -> None:
        ...
        from buquet_workflow._buquet_workflow import parse_signal_key
...
class TestPublicApiTypes:
    ...
    def test_public_exports_match_all(self) -> None:
        ...
        for name in buquet_workflow.__all__:
            assert hasattr(buquet_workflow, name), f"Missing export: {name}"
