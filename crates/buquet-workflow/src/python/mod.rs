//! Python bindings for buquet-workflow.
//!
...
/// The `buquet_workflow` Python module.
///
/// Provides workflow orchestration functionality built on buquet.
#[pymodule]
#[pyo3(name = "_buquet_workflow")]
pub fn buquet_workflow(m: &Bound<'_, PyModule>) -> PyResult<()> {
    // Type classes
