//! buquet-workflow: durable orchestration layer built on buquet.
//!
//! This crate provides workflow orchestration on top of the buquet task queue,
...
/// Placeholder version marker for the buquet-workflow crate.
