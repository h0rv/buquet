...
from oq import Queue, TaskContext, Worker, WorkerRunOptions, connect
...
class TestTaskContextTypes:
    ...
    def test_task_context_importable_from_native_module(self) -> None:
        """Test that TaskContext can be imported from oq._oq native module."""
        # TaskContext is defined in the native module
        from oq._oq import TaskContext as NativeTaskContext  # noqa: PLC0415
