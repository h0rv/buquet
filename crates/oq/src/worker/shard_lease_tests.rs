...
mod shard_lease_config_tests {
    ...
    fn clear_env_vars() {
        std::env::remove_var("OQ_SHARD_LEASING");
        std::env::remove_var("OQ_SHARD_LEASING_SHARDS_PER_WORKER");
        std::env::remove_var("OQ_SHARD_LEASING_TTL_SECS");
        std::env::remove_var("OQ_SHARD_LEASING_RENEW_SECS");
    }
    ...
    fn test_config_from_env_enabled() {
        ...
        std::env::set_var("OQ_SHARD_LEASING", "1");
        std::env::set_var("OQ_SHARD_LEASING_SHARDS_PER_WORKER", "8");
        std::env::set_var("OQ_SHARD_LEASING_TTL_SECS", "60");
        std::env::set_var("OQ_SHARD_LEASING_RENEW_SECS", "20");
    ...
    fn test_config_from_env_enabled_true_string() {
        ...
        std::env::set_var("OQ_SHARD_LEASING", "true");
    ...
    fn test_config_from_env_disabled_false_string() {
        ...
        std::env::set_var("OQ_SHARD_LEASING", "false");
