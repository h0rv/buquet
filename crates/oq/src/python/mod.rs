//! Python bindings for the oq task queue.
//!
...
/// The oq Python module.
///
/// Provides access to the S3-based task queue from Python.
#[pymodule]
#[pyo3(name = "_oq")]
pub fn oq(m: &Bound<'_, PyModule>) -> PyResult<()> {
...
/// - `OQ_SHARD_PREFIX_LEN` (optional): Number of hex characters for shard prefix (1-4)
///
...
/// * `shard_prefix_len` - Optional shard prefix length 1-4 (overrides `OQ_SHARD_PREFIX_LEN`)
///   - 1 = 16 shards (default)
///   - 2 = 256 shards
///   - 3 = 4096 shards
///   - 4 = 65536 shards
