...
class TestEnvironmentVariableConfiguration:
    ...
    def test_env_var_names_documented(self):
        ...
        expected_vars = [
            "QO_SHARD_LEASING",
            "QO_SHARD_LEASING_SHARDS_PER_WORKER",
            "QO_SHARD_LEASING_TTL_SECS",
            "QO_SHARD_LEASING_RENEW_SECS",
        ]
        # Just verify these are the documented names
        for var in expected_vars:
            assert var.startswith("QO_SHARD_LEASING"), (
                f"Env var {var} should start with QO_SHARD_LEASING"
            )
