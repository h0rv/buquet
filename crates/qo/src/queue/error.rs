...
mod tests {
    ...
    fn test_not_found_suggestion() {
        ...
        assert!(err.suggestion().contains("qo history"));
    }
    ...
    fn test_already_completed_suggestion() {
        ...
        assert!(err.suggestion().contains("qo status"));
    }
